# A system for participants to vote on a list of proposals. 
# The chairperson of the contract will be able to give each participant the right to vote, and each participant may choose to vote, or delegate their vote to another voter. 
# Finally, a winning proposal will be determined upon calling the winning_proposals() method, which iterates through all the proposals and returns the one with the greatest number of votes.
